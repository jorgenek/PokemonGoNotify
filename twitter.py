...
def tweet(url, id, name, iv, attack, defense, stamina, cp, gender, move1, move2, lat, lng, disappear, level, form, config):
    ...
    if attack is not None:
        ...
        if name.lower() == 'unown':
            infoPost = "#" + str(id) + " " + name + " " + disappear + ", Form:" + str(form) + ", IV:" + str(iv) + " (" + str(attack) + "/" + str(defense) + "/" + str(stamina) + "), cp" + str(cp) + ", lvl:" + str(level) + ", " + str(move) + ". "
        else:
            infoPost = "#" + str(id) + " " + name + " " + disappear + ", IV:" + str(iv) + " (" + str(attack) + "/" + str(defense) + "/" + str(stamina) + "), cp" + str(cp) + ", lvl:" + str(level) + ", " + str(move) + ", " + str(gender) + ". "

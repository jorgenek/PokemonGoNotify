...
moves = {
    ...
    '201': 'Bug Bite(Bug) 5',
    '202': 'Bite(Dark) 10',
    '203': 'Sucker Punch(Dark) 8',
    '204': 'Dragon Breath(Dragon) 12',
    '205': 'Thunder Shock(Electric) 6',
    '206': 'Spark(Electric) 8',
    '207': 'Low Kick(Fighting) 6',
    '208': 'Karate Chop(Fighting) 8',
    '209': 'Ember(Fire) 10',
    '211': 'Peck(Flying) 10',
    '212': 'Lick(Ghost) 5',
    '213': 'Shadow Claw(Ghost) 12',
    '214': 'Vine Whip(Grass) 8',
    '215': 'Razor Leaf(Grass) 15',
    '216': 'Mud Shot(Ground) 9',
    '217': 'Ice Shard(Ice) 12',
    '218': 'Frost Breath(Ice) 10',
    '219': 'Quick Attack(Normal) 10',
    '220': 'Scratch(Normal) 12',
    '221': 'Tackle(Normal) 10',
    '222': 'Pound(Normal) 8',
    '223': 'Cut(Normal) 5',
